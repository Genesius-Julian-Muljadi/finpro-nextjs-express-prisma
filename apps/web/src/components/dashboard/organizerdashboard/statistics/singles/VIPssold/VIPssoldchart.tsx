...
class SingleVIPsSold extends Component<{
    ...
    updateChart(transactions: Array<Transactions>, days: number, date: Date) {
      ...
      for (let k in transactionData) {
        ...
        this.seriesData[(days - 1) - (capVal - dateVal)] += transactionData[k].VIPs;
      };
    ...
    render() {
      return (
        <div className="app">
          <div className="row">
            <div className="text-center font-semibold">VIP Tickets Sold</div>
          </div>
          <div className="row">
