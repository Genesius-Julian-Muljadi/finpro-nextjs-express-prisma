...
import { LoginOrganizer, LoginUser, RegisterOrganizer, RegisterUser, TallyPointsByUserID, VerifyOrganizer } from "../controllers/auth_controllers";
...
router.get("/points/:id", TallyPointsByUserID);
